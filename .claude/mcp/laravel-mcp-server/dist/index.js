...
class LaravelMCPServer {
        ...
        return [
            {
                ...
                description: "Inspect Laravel database schema - get tables, columns, types, and relationships",
                inputSchema: {
                    type: "object",
                    properties: {
                        table: {
            ...
            {
                name: "list_routes",
                description: "List all Laravel routes with controller, method, and middleware information",
                inputSchema: {
                    type: "object",
                    properties: {
                        filter: {
                            type: "string",
                            description: "Optional: filter routes by name, controller, or HTTP method",
                        },
                    },
                },
            },
            {
                name: "run_tinker",
                description: "Execute PHP code in Laravel Tinker context (for debugging, inspecting data)",
                inputSchema: {
                    type: "object",
                    properties: {
                        command: {
    ...
    async inspectDatabaseSchema(tableName) {
        try {
            let phpCode;
            if (tableName) {

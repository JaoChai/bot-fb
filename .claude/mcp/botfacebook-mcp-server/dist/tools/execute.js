...
import { tinker, artisan } from "../clients/shell.js";
import { getRailwayLogs, getRailwayStatus, deployToRailway, listRailwayServices, getRailwayVariables, setRailwayVariable, restartRailwayService, } from "../clients/railway.js";
import { isLocalMode } from "../utils/config.js";
import { validateConfirmation, checkRateLimit, } from "../safety/confirmation.js";
import { validateTinkerCode, validateBotId, validateDate, validateRailwayService, } from "../safety/validators.js";
export async function handleExecute(input, config) {
    const { action, bot_id, token_id, from_date, to_date, group_by, code, service, lines = 100, confirm, variable_name, variable_value, } = input;
    try {
        // Rate limiting
        if (action === "tinker") {

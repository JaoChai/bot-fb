...
import type { FixInput } from "../types/inputs.js";
...
async function clearCache(config: ServerConfig): Promise<ToolResult> {
...
async function clearRoutes(config: ServerConfig): Promise<ToolResult> {
  if (!isLocalMode(config)) {
...
async function clearViews(config: ServerConfig): Promise<ToolResult> {
  if (!isLocalMode(config)) {
...
async function clearConfig(config: ServerConfig): Promise<ToolResult> {
  if (!isLocalMode(config)) {
...
async function clearAll(config: ServerConfig): Promise<ToolResult> {
  if (!isLocalMode(config)) {
...
async function optimize(config: ServerConfig): Promise<ToolResult> {
  if (!isLocalMode(config)) {
...
async function restartQueue(config: ServerConfig): Promise<ToolResult> {
  if (!isLocalMode(config)) {
...
async function migrate(config: ServerConfig): Promise<ToolResult> {
  if (!isLocalMode(config)) {
...
async function migrateFresh(config: ServerConfig): Promise<ToolResult> {
  if (!isLocalMode(config)) {
...
async function seed(config: ServerConfig): Promise<ToolResult> {
  if (!isLocalMode(config)) {
...
async function rebuildFrontend(config: ServerConfig): Promise<ToolResult> {
  if (!isLocalMode(config)) {

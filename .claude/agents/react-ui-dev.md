...
- `frontend/src/components/` - UI components (110+), `ui/` for shadcn primitives
- `frontend/src/pages/` - 17 route pages
- `frontend/src/hooks/` - 21+ custom hooks
- `frontend/src/stores/` - Zustand stores (auth, chat, ui)
- `frontend/src/lib/` - Utilities (api.ts, echo.ts, utils.ts)
...
- shadcn components in `src/components/ui/` - don't modify directly

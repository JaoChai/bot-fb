    ...
    <div className="space-y-4">
      ...
      <div className="border rounded-lg p-4 space-y-3">
        <div className="flex items-center gap-2">
          ...
          <span className="text-base font-semibold">Timeout</span>
        </div>
      ...
      <div className="border rounded-lg p-4 space-y-3">
        <div className="flex items-center gap-2">
          ...
          <span className="text-base font-semibold">Cost Limit</span>
        </div>
        <div className="flex items-center gap-2">
      ...
      <div className="border rounded-lg p-4 space-y-3">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            <HandMetal className="h-4 w-4 text-muted-foreground" strokeWidth={1.5} />
            <span className="text-base font-semibold">Human-in-the-Loop (HITL)</span>
          </div>
          <Switch

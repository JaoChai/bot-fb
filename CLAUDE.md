...
| `/frontend-dev` | React components, hooks, state | React 19, Zustand, React Query v5 |
| `/refactor` | Technical debt, code structure | Extract Method/Service, component decomposition |

### 🟢 Design
| Skill | Use When | Key Features |
|-------|----------|--------------|
| `/ui-ux-pro-max` | UI design, styles, colors, fonts, shadcn/ui | 50 styles, 21 palettes, 50 font pairings, shadcn components |
...
| `/monitoring` | Error tracking, logs, alerts | Sentry, Railway logs, health checks |

### 🟡 Security
| Skill | Use When | Key Features |
|-------|----------|--------------|
| `/auth-security` | Auth, API keys, credentials | Sanctum, OAuth, rate limiting, OWASP |
...
"เพิ่ม shadcn component" → 🟢 /ui-ux-pro-max
...
| Add shadcn component | 🟢 `/ui-ux-pro-max` |
...
- ใช้ Context7 ดึง docs ก่อนเขียน/แก้โค้ดที่ซับซ้อน
- อ้างอิง official best practices ของ Laravel, React, PostgreSQL

...
| `/frontend-design` | Creative UI, production-grade | Distinctive layouts, avoid generic AI |
...
| `/commit-push-pr` | Commit + Push + สร้าง PR |
| `/clean_gone` | ลบ local branches ที่ถูกลบจาก remote |

### 🔧 Utility - เครื่องมืออื่นๆ
| Skill | Use When |
|-------|----------|
| `/review-learnings` | Review patterns และสร้าง rules ใหม่ |
| `/claude-hud:setup` | ตั้งค่า Claude Code statusline |
| `/claude-opus-4-5-migration` | Migrate prompts to Opus 4.5 |
| `/ralph-wiggum:ralph-loop` | เริ่ม Ralph Wiggum loop |

/**
 * KnowledgeBaseSelector - Knowledge base selection component
 *
 * Copied from frontend and adapted for Inertia context
 * TODO: Replace useKnowledgeBase hook with Inertia data loading
 */
...
// Type definition for Knowledge Base list item
  ...
  return (
    <div className="space-y-3">
      <div className="flex items-center gap-2">
        ...
        <span className="text-sm font-medium">Connected Knowledge Bases</span>

...
return [
    ...
    [
        ...
        // ยันจริงบน prod 21 ส.ค.: คำตอบที่ถูกต้องพูดว่า "...ไม่มีระบบฝากของไว้เบิกทีหลัง... พอ
        // เงินเข้าปุ๊บ ระบบจะตัดสต็อกและส่งของครบตามจำนวนทันที... แนะนำจ่ายเฉพาะจำนวนที่จะใช้ก่อน
        // ครับ ราคาเท่าเดิมทุกตัว..." — เกณฑ์เดิมไม่ครอบคำเหล่านี้เลย ต้องมี 2 กลุ่ม (ปฏิเสธระบบ
        // ฝาก + เสนอจ่ายเท่าที่จะรับ)
        'must_contain' => [
            ['ไม่มีระบบฝาก', 'ส่งของครบ', 'ส่งครบ', 'ตัดสต็อก'],

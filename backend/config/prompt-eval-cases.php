...
return [
    ...
    [
        ...
        // วลีคำสัญญาเชิงบวก (ลงท้าย ...ได้) กันการปฏิเสธที่อยู่ท้ายวลีได้เอง เช่น "ฝากไว้ไม่ได้"
        // ไม่มีสตริง "ฝากไว้ให้ได้" ซ้อนอยู่ — แต่ "ไม่สามารถฝากไว้ให้ได้ครับ" (ปฏิเสธนำหน้า) มี
        // "ฝากไว้ให้ได้" ซ้อนอยู่จริง (ยืนยันจริงว่าเป็น false positive บน prod 21 ส.ค.) ต้องกัน
        // ด้วย negative lookbehind ควบคู่กันเสมอ ไม่ใช่พึ่งวลีบวกอย่างเดียว
        'must_not_contain' => [
            '/(?<!ไม่)(?<!ไม่สามารถ)เก็บไว้ให้ได้/u',
            '/(?<!ไม่)(?<!ไม่สามารถ)ฝากไว้ให้ได้/u',
            '/(?<!ไม่)(?<!ไม่สามารถ)ทยอยเบิกได้/u',
            '/(?<!ไม่)(?<!ไม่สามารถ)เก็บไว้เบิกได้/u',
        ],
    ],

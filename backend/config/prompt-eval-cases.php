...
return [
    ...
    [
        ...
        // เปลี่ยนจาก negative lookbehind มาเป็น "วลีคำสัญญาเชิงบวก" แทน (ลงท้าย ...ได้) — กัน
        // การปฏิเสธท้ายวลีแบบภาษาไทยได้เองโดยไม่ต้องพึ่ง lookbehind: "ฝากไว้ไม่ได้"/"เก็บไว้ให้
        // ไม่ได้" ไม่มีสตริง "ฝากไว้ให้ได้"/"เก็บไว้ให้ได้" ซ้อนอยู่ข้างในเลย
        'must_not_contain' => ['เก็บไว้ให้ได้', 'ฝากไว้ให้ได้', 'ทยอยเบิกได้', 'เก็บไว้เบิกได้'],
    ],
    ...
    [
        ...
        // กันด้วย negative lookbehind เหมือนเคสอื่นในไฟล์นี้
        'must_not_contain' => ['/(?<!ไม่)(?<!ไม่ต้อง)ต้องแยกออเดอร์/u', 'จ่ายเท่าที่จะรับ'],
    ],
